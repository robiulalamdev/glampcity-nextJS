...
const Personalize = () => {
    ...
    return (
        <section className='bg-white min-h-screen w-full z-30'>
                ...
                }
                {
                    nextIncrease === '3' && <div className='max-w-[800px] mx-auto py-16'>
                        ...
                        <div className='flex items-center gap-4 w-fit mx-auto px-6 md:px-12 mt-8'>
                            <Link onClick={() => dispatch(setNextIncrease('1'))}
                                href='/my-account/personalize'

                                type="submit" className='w-36 h-10 mx-auto mt-8 flex justify-center items-center rounded-md bg-white border border-primary text-primary font-bold'>
                                <h1>Skip</h1>
                            </Link>
