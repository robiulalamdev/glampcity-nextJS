        ...
        <section>
            <div className='bg-white'>
                <div className='max-w-[1440px] mx-auto px-2 md:px-8 pb-12'>
                    ...
                    <div className='flex flex-col md:flex-row md:items-center gap-2 md:gap-4 my-6'>
                        {
                            items?.map((item, i) => (
                                <button onClick={() => setSelectedData(item)}
                                    className={`flex justify-center items-center w-full md:w-56 h-10 md:h-12 border rounded-md  
                    ${selectedData === item ? 'bg-primary text-white' : 'text-primary border-primary hover:bg-blue-400 hover:text-white duration-300'}`}>
                                    <span className='md:text-xl font-semibold'>{item}</span>
                                </button>
                            ))
                        }
                        ...
                        <Link href="/order-refunds"
                            ...
                            <span className='md:text-xl font-semibold'>Order Refunds</span>
                        </Link>
