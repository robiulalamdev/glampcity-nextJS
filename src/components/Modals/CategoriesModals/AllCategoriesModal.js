...
const AllCategoriesModal = ({ allCategories, closeModal }) => {
    ...
    return (
        <div
            ...
            <div ref={modalRef} className='h-full w-full md:h-[600px] md:w-[800px] mx-auto bg-white shadow border border-blue-600 zoom-in'>
                <div className='min-h-[300px] max-h-full overflow-y-auto'>
                    ...
                    {
                        allCategories && allCategories?.map(category => <Link href={`/product-list/${category?.slug}`}
