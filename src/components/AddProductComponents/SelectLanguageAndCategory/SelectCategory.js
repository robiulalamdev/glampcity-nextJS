        ...
        <div className='bg-white p-2 rounded shadow w-full md:max-w-md'>
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input onChange={(e) => handleSearch(e.target.value)} type="search" id="default-search" className="max-w-full w-full  h-12 px-3 border border-blue-400 focus:border-primary rounded focus:outline-none block p-4 pl-10 text-sm text-gray-900 bg-gray-50 focus:ring-blue-500" placeholder="Search Mockups, Logos..." required />
