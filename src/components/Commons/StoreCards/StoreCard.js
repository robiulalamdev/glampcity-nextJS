...
const StoreCard = ({ store }) => {
    ...
    return (
        <Link href={`/stores/${store?.username}`} className='cursor-pointer w-fit h-fit flex justify-center items-center mx-auto rounded-full border-[12px] md:border-[20px] border-gray-400 hover:border-primary duration-150 relative'>
