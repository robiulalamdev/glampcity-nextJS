            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-4 min-h-[500px] max-h-[500px] overflow-y-auto scrollBar cursor-pointer'>
                {
                    products?.map(product => (
                        <div className="border border-gray-600/20 bg-white h-fit" id='box-shadow' >
                            <div className='relative w-96 md:w-auto h-32 mx-auto overflow-hidden bg-slate-200 group'>
